...
- This repository: the **living version** — the standard, the genealogy register (updated as members are certified), the application template, and the currently posed problems.
  - The public **axiom-set ledger** (five member layers, three-line format, CN+EN, [DOI 10.5281/zenodo.22874214](https://doi.org/10.5281/zenodo.22874214)): [`constructive_mathematics_axioms_CN_v1.0.md`](constructive_mathematics_axioms_CN_v1.0.md) / [`constructive_mathematics_axioms_EN_v1.0.md`](constructive_mathematics_axioms_EN_v1.0.md)
