...
> **v1.1 (2026-09-20)**: Added §4.1 — derivation from, axiomatic absorption by, and completion of a member's axiom system. This addresses the boundary question "can an intra-system derived structure be certified as a new member?" (first case study on record). The criteria body (the C-criteria) is unchanged.
...
*Release v1.0 | 2026-09-16 · v1.1 | 2026-09-20 (§4.1 added: derivation, absorption, completion — first case study on record) | Zenodo version chain of the same record | Chinese edition synchronized (论文_构造数学认证标准_Standard_v1.1.md) | Genealogy register snapshot: five members + representation mathematics separately listed, all C6 at the hard-criterion level*
